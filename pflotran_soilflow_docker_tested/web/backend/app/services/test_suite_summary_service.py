...
SUITE_STATUS_ARTIFACTS = (SUITE_STATUS_JSON, SUITE_STATUS_TEXT)
SUITE_ARTIFACTS = (SUITE_STATUS_JSON, SUITE_RESULTS_CSV, STRICT_READINESS_PLAN_JSON, SUITE_STATUS_TEXT)
