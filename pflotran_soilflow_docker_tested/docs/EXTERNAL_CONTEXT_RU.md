...
14. Verification-suite status artifacts содержат `failure_stage=generation|solver|evaluator`, чтобы suite CSV/API отличали сбой подготовки входных файлов, внешнего solver-а и evaluator/parser слоя.
