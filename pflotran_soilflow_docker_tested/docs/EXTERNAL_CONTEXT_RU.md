...
- `richards_mms_case.py`: uniform storage `SOURCE_SINK` candidate deck,
  initial/source artifacts и cell-wise MMS residual table для следующего шага к
  PFLOTRAN spatial source adapter;
